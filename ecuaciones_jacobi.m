%ecuaciones_jabobi, encuentra la solución aproximada de un sistema 
%de ecuaciones utilizando el método de Jacobi
...
function [solucion] = ecuaciones_jacobi(matriz, vector, solucion_inicial, ...
    ...
    while(iterar==1 && iteracion_actual<=limite_iteraciones)
            ...
            for contador_columnas=1:tam_vector
                ...
                aproximacion(contador_columnas)=(vector(contador_columnas)-sumatoria)...
                            /(matriz(contador_columnas,contador_columnas));
