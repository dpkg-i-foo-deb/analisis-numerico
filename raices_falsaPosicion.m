%raices_falsaPosicion, encuentra la raiz de una ecuación utilizando falsa
%posición
...
function [raiz] = raices_falsaPosicion(ecuacion, lim_izquierda, lim_derecha, tolerancia)
    ...
    while (iterar)
        ...
        aproximacion = (lim_derecha-((ecuacion(lim_derecha)*(lim_izquierda-lim_derecha)) ...
                        /(ecuacion(lim_izquierda)-ecuacion(lim_derecha))));
